...
import Foundation
import Alamofire
public typealias CacheLeafRequestExecutor = (URLRequest, @escaping (URLRequest?, HTTPURLResponse?, Data?, Error?)-> Void) -> Void
